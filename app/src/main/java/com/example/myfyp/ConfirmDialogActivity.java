...
public class ConfirmDialogActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    //EDITTEXTS FOR THE LOCATION PARAMETERS
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //GETTING VALUES FROM THE MAPSACTIVITY AND SETTING INTO EDITTEXTS
    ...
    public void onClick(View v) {
        if(v.getId() == R.id.buttonCancel) {
            ...
            //Intent to the FirstActivity containing all the data.
            ...
            //If all data values are valid, return with the RESULT_OK and the collects data.
